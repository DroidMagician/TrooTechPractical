...
class SharedPrefs (private val context: Context) {
    ...
    fun getLoginDetail(): FirebaseUserModel? {
        val gson = Gson()
        val json = sharedPref?.getString(LOGIN_DATA, "")
        return gson.fromJson<FirebaseUserModel>(json, FirebaseUserModel::class.java)
    }
